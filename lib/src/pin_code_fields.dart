...
class PinCodeTextField extends StatefulWidget {
  ...
  /// Use indexed hint characters
  final bool indexedHintCharacters;
  ...
  PinCodeTextField({
    ...
    this.indexedHintCharacters = false,
...
class _PinCodeTextFieldState extends State<PinCodeTextField>
  ...
  bool get _indexedHint => widget.indexedHintCharacters;
  ...
  Widget _renderPinField({
    ...
    if (_inputList[index!].isEmpty && (_hintAvailable || _indexedHint)) {
      final text = _indexedHint ? (index + 1).toString() : widget.hintCharacter;
      return Text(
        text ?? '',
